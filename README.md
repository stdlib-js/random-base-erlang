...
```javascript
import erlang from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-erlang@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-base-erlang/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-base-erlang/actions/workflows/test.yml?query=branch:v0.2.2
